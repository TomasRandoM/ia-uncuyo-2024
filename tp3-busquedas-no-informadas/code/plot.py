...
def plotData(results, filename):
    ...
    algorithms =["BFS", "DFS", "DLS", "UCS_e1", "UCS_e2", "A*_e1", "A*_e2", "Random"]
    ...
    #Se añaden las etiquetas a los valores del eje X
    plot.xticks(range(1, len(algorithms) + 1), algorithms)
    #Se añade el título
    plot.title("Cantidad de veces que alcanzaron el objetivo en menos de 1000 acciones")
    #Se añade el título del eje X
    plot.xlabel("Algortimos")
    #Se añade el título del eje Y
    plot.ylabel("Cantidad de veces")
    #Se hace visible la cuadrícula en el gráfico
    plot.grid(True)
