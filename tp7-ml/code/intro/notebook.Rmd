...
library(rpart)
dataValidation <- read.csv("../../data/arbolado-mendoza-dataset-train.csv", header = TRUE, sep = ",")
...
write.csv(metricasMean, file = "../metricsMean.csv")
