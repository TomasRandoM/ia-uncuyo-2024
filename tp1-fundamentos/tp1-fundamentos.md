# Trabajo práctico 1 - Inteligencia artificial - Tomás Rando
...
Existen ciertas teorías, como la teoría monista o fisicalismo, que sostiene que la mente no se debe separar del cuerpo, es decir, que los estados mentales son estados físicos. Esta teoría conduciría a la posibilidad de la existencia de la inteligencia artificial fuerte.
...
Luego de la lectura del paper, no creo que se pueda considerar a los agentes conversacionales basados en grandes modelos de lenguaje como conscientes. Esto es así ya que el autor nos menciona que estos agentes, al menos por el momento, no poseen verdaderos deseos, sentimientos ni intenciones, sino que los simulan como si fuera un juego de rol. Además, nos menciona que no es posible realizar "encuentros" con la inteligencia artificial, es decir, si bien sería posible incorporarla en robots avanzados, para nosotros no sería igual por la diferencia fisiológica. Aunque, en el futuro podría realizarse un encuentro en un mundo virtual lo suficientemente convincente para eventualmente cambiar la forma en la que percibimos a la conciencia de los agentes.
## 2. 

Atribuir conciencia y derechos morales a los agentes de IA avanzados podría tener algunas consecuencias. Una de ellas es que estos agentes podrían ser antropomorfizados injustificadamente, pues, podrán realizar acciones que hacemos los humanos, pero no son humanos. Además, algunas personas podrían priorizar el bienestar de las IA por encima del de otros humanos. Por último, el texto menciona la posibilidad futura de que las relaciones entre humanos pasen a segundo plano debido a la preferencia de compañía de estos agentes por parte de otros humanos. 
